...
function initReportCharts() {
    ...
    setTimeout(() => {
        const dailyCtx = document.getElementById('reportChartDaily');
        if (dailyCtx) {
            new Chart(dailyCtx, {
                type: 'line',
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [420, 550, 480, 620, 590, 650, 580],
                        borderColor: '#667eea',
        ...
        // Operators Chart
        const operatorsCtx = document.getElementById('reportChartOperators');
        if (operatorsCtx) {
            new Chart(operatorsCtx, {
                type: 'bar',
                data: {
                    labels: ['Juan P.', 'María G.', 'Carlos L.', 'Ana M.', 'Luis R.'],
                    datasets: [{
                        label: 'Productividad',
                        data: [450, 520, 380, 490, 410],
                        backgroundColor: [
        ...
        const timeCtx = document.getElementById('reportChartTime');
        if (timeCtx) {
            new Chart(timeCtx, {
                type: 'doughnut',
                data: {
                    labels: ['Digitalización', 'Organización', 'Recepción', 'Inspección', 'Otros'],
                    datasets: [{
                        data: [35, 25, 20, 12, 8],
                        backgroundColor: [
                            'rgba(102, 126, 234, 0.8)',
                ...
                options: {
                    ...
                    plugins: {
                        legend: {
                            position: 'bottom',
                            labels: { color: '#b4b4d4', padding: 15 }
                        }
                    },
                    cutout: '60%'
                }
        ...
        // Top Processes Chart
        const processesCtx = document.getElementById('reportChartProcesses');
        if (processesCtx) {
            new Chart(processesCtx, {
                type: 'bar',
                data: {
                    labels: ['BC16', 'BC17', 'BC8', 'BC6', 'BC12'],
                    datasets: [{
                        label: 'Frecuencia',
                        data: [45, 38, 32, 28, 22],
